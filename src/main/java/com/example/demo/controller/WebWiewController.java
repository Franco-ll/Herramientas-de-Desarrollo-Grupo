...
public String updateProfile(
    ...
    public String processPayment(@org.springframework.web.bind.annotation.RequestParam Long alojamientoId,
        ...
        reserva.setFechaInicio(java.time.LocalDate.parse(fechaInicio));
        reserva.setFechaFin(java.time.LocalDate.parse(fechaFin));
    ...
    public String viewAllReviews(@org.springframework.web.bind.annotation.RequestParam Long alojamientoId,
        ...
        model.addAttribute("usuario", usuario);
        model.addAttribute("alojamiento", alojamiento);
        model.addAttribute("resenas", resenaService.obtenerResenasPorAlojamiento(alojamientoId));
        return "ver_todas_las_resenas";
    }
    ...
    public String publishReview(@org.springframework.web.bind.annotation.RequestParam Long alojamientoId,
            @org.springframework.web.bind.annotation.RequestParam Integer calificacion,
            @org.springframework.web.bind.annotation.RequestParam String comentario,
            HttpSession session) {
        Usuario usuario = (Usuario) session.getAttribute("loggedUser");
        if (usuario == null)
            return "redirect:/login";
        ...
        resena.setFechaPublicacion(java.time.LocalDate.now());
