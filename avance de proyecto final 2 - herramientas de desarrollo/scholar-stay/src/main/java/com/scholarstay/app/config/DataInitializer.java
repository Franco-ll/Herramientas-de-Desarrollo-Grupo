    ...
    CommandLineRunner initData(AlojamientoRepository repository,
        ...
        return args -> {
            ...
            if (usuarioRepository.findByEmail("admin@scholarstay.com").isEmpty()) {
                Usuario admin = new Usuario("Administrador", "admin@scholarstay.com", passwordEncoder.encode("admin123"));
            ...
            if (repository.count() == 0) {
                ...
                a1.setDescripcion(
                        "Estudio totalmente equipado con luz natural y área de estudio dedicada. Ideal para estudiantes que buscan independencia y comodidad.");
                ...
                a1.setServicios(
                        Arrays.asList("Wifi Alta Velocidad", "AC Central", "Escritorio Ergonómico", "Cocina Equipada"));
                ...
                a2.setDescripcion(
                        "Habitación compartida con todas las comodidades y servicios incluidos. Ambiente multicultural y vibrante.");
                ...
                a2.setReglas(
                        Arrays.asList("Visitas hasta las 9 PM", "Respetar turnos de limpieza", "No ruidos fuertes"));

                Alojamiento a3 = new Alojamiento();
                a3.setTitulo("Apartamento Amplio para Estudiantes");
                a3.setDescripcion(
                        "Sala de estar espaciosa y cocina moderna. Perfecto para grupos de amigos que quieren compartir gastos y experiencias.");
                ...
                a3.setReglas(Arrays.asList("No fiestas grandes", "Mantener áreas comunes ordenadas",
                        "Cuidado con los muebles"));

                Alojamiento a4 = new Alojamiento();
                a4.setTitulo("Estudio Privado con Vista a la Ciudad");
                a4.setDescripcion(
                        "Compacto pero funcional, diseñado específicamente para el enfoque académico. Vista inspiradora.");
                ...
                a5.setDescripcion(
                        "Ambiente tranquilo y social en áreas comunes. Servicios premium para quienes necesitan concentración máxima.");
                ...
                a5.setReglas(Arrays.asList("Silencio total en pasillos", "Uso responsable de biblioteca",
                        "Cuidado de áreas verdes"));

                Alojamiento a6 = new Alojamiento();
                a6.setTitulo("Residencia Estudiantil Central");
                a6.setDescripcion(
                        "Habitación amplia con todos los servicios en el corazón de la ciudad. Cerca de todo lo que necesitas.");
                ...
                a7.setDescripcion(
                        "Diseño moderno y funcional, ideal para estudiantes de postgrado que buscan paz y orden.");
                ...
                a7.setServicios(Arrays.asList("Cámaras de seguridad", "Intercomunicador", "Área de lectura",
                        "Aire Acondicionado"));
                ...
                a8.setDescripcion(
                        "Ambiente familiar y tranquilo, a pocas cuadras de la facultad. Patio trasero ideal para estudiar al aire libre.");
                ...
                a8.setReglas(Arrays.asList("Turnos de limpieza", "No ruidos después de las 11 PM",
                        "Compartir gastos comunes"));

                Alojamiento a9 = new Alojamiento();
                a9.setTitulo("Apartamento Ejecutivo Los Geranios");
                a9.setDescripcion(
                        "Acabados de lujo y seguridad 24 horas. Cerca de centros comerciales y zonas de ocio universitario.");
                ...
                a9.setReglas(
                        Arrays.asList("No ruidos molestos", "Uso correcto de piscina", "Identificación en portería"));

                Alojamiento a10 = new Alojamiento();
                a10.setTitulo("Habitación Económica Estudiantil");
                a10.setDescripcion(
                        "Opción accesible con internet de alta velocidad incluido. Todo lo básico para un estudiante enfocado.");
                ...
                a10.setServicios(
                        Arrays.asList("Internet 500Mbps", "Ventilador", "Mesa de estudio", "Cerca a paraderos"));
